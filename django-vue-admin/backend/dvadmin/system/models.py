...
class GlossaryNode(CoreModel):
    parent = models.ForeignKey(to="GlossaryNode", on_delete=models.CASCADE, null=True,blank=True,db_constraint=False, help_text="上级节点",verbose_name="上级节点",)
    node = models.CharField(max_length=20, null=True,blank=True, verbose_name="术语节点名称", help_text="术语节点名称")

    class Meta:
        db_table = table_prefix + "glossary_node"
        verbose_name = "术语节点"
        verbose_name_plural = verbose_name
        ordering = ("-create_datetime",)
...
class GlossaryLibrary(CoreModel):
    library_name = models.CharField(max_length=20, null=False,blank=False, verbose_name="术语库名称", help_text="术语库名称",)

    class Meta:
        db_table = table_prefix + "glossary_library"
        verbose_name = "术语任务"
        verbose_name_plural = verbose_name
        ordering = ("-create_datetime",)
...
class GlossaryTerms(CoreModel):
    # node = models.ForeignKey(to="GlossaryNode", on_delete=models.CASCADE, db_constraint=True, null=True, blank=True, db_index=True, verbose_name="节点ID", help_text="节点ID", related_name='terms_at_node')
    library = models.ForeignKey(to="GlossaryLibrary", on_delete=models.CASCADE, db_constraint=True, null=True, blank=True, db_index=True, verbose_name="术语库ID", help_text="术语库ID", related_name='terms_at_library')
    ...
    node = models.ForeignKey(to="GlossaryNode",verbose_name="节点",on_delete=models.PROTECT,db_constraint=False,null=True,blank=True,help_text="关联节点",)
    parent = models.ForeignKey(to="GlossaryTerms", on_delete=models.CASCADE, null=True, blank=True, db_constraint=False, help_text="上级术语", verbose_name="上级术语")

    term_name = models.CharField(max_length=50, null=False,blank=False, verbose_name="术语名称", help_text="术语名称",)
    code = models.CharField(max_length=50, null=True,blank=True, verbose_name="术语编码", help_text="术语编码",)
    synonymous = models.JSONField(null=True, verbose_name="同义词", help_text="同义词")
    review = models.IntegerField(choices=((0, "未审核"),(1, "审核通过") ), default=0, verbose_name="审核状态", help_text="审核状态")
    # uper_word = models.JSONField(null=True, verbose_name="上位词", help_text="上位词")
    # down_word = models.JSONField(null=True, verbose_name="下位词", help_text="下位词")

    class Meta:
        db_table = table_prefix + "glossary_terms"
        verbose_name = "术语管理"
        verbose_name_plural = verbose_name
        ordering = ("-create_datetime",)
