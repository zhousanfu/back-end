...
'''
 Author: Sanfor Chow
 Date: 2022-11-24 10:33:57
 LastEditors: Sanfor Chow
 LastEditTime: 2022-11-24 14:51:27
 FilePath: /zhihui_api_backend/django-vue-admin/backend/dvadmin/system/urls.py
'''
...
from dvadmin.system.views.glossary import GlossaryTermsViewSet, GlossaryLibraryViewSet, GlossaryNodeViewSet
...
system_url.register(r'term', GlossaryTermsViewSet)
system_url.register(r'termlibrary', GlossaryLibraryViewSet)
system_url.register(r'termnode', GlossaryNodeViewSet)
